...
class Activity(BaseModel):
    ...
    time: str = Field(description="Time of the day for an activity e.g. Morning, Afternoon, Evening")
...
class HotelOption(BaseModel):
    ...
    price_per_night: Optional[float] = Field(default=None,description="Price per night")
...
class DayPlan(BaseModel):
    ...
    weather: Optional[str] = Field(default=None, description="Short weather note for this specific day")
